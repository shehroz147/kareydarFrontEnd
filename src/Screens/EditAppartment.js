...
export default function EditAppartment({ route }) {
    ...
    const editProfile = async () => {
        ...
        console.log(data)
        const response = await server.post('Appartment/update', data);
                ...
                <ScrollView>
                    ...
                    >
                        ...
                        <View>
                            ...
                            <View style={{
                                ...
                                <TextInput
                                    ...
                                    value={kitchen}
                                    placeholder={`${property.kitchen} "Kitchen"`}
                                ...
                                <TextInput
                                    ...
                                    value={bathroom}
                                    placeholder={`${property.Bathroom} "Bathrooms"`}
                                    placeholderTextColor={'black'}
                        ...
                        <Pressable style={{
                            ...
                            onPress={() => {
                                navigation.navigate('AppartmentRequest', { property: property })
                            }}
                        >
                            <Text
                                style={{
